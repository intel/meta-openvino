...
PACKAGECONFIG[iomp] = "-DTHREADING=OMP -DINTEL_OMP='${RECIPE_SYSROOT}${prefix}' -DINTEL_OMP_LIBRARIES_RELEASE='${RECIPE_SYSROOT}${libdir}/libiomp5.so', , intel-openmp, , , tbb omp seq"
PACKAGECONFIG[seq] = "-DTHREADING=SEQ, , , , , tbb omp iomp"
...
FILES:${PN}-python3 = "${PYTHON_SITEPACKAGES_DIR} ${bindir}/ovc ${bindir}/opt_in_out ${bindir}/benchmark_app_python3"
